...
$whitelist=array("localhost", "localhost:8003", "localhost:4201", "<your_institution>.primo.exlibrisgroup.com");
...
$key=" ";    /* enter key here  */
$illiadDomain="illiad.lib.<your_institution>.edu"; /* e.g. illiad.myinst.edu */
